<script>
    ...
    let items = [
        ...
        { id: 6, title: "Kiro", status: "Korrektur" }
    ]
...
.planning { background: #dce7ff; color: #244b9b; }
.correction { background: #ffe8c6; color: #8a5f0a; }
.done { background: #d3fbd8; color: #155d15; }
.progress { background: #ffe2a3; color: #8a5b00; }
.canceled { background: #ffd2d2; color: #8a1a1a; }
